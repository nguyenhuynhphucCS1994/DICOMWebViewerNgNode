...
function loadStudy(studyViewer, viewportModel, studyId) {
    ...
    $.getJSON('assets/studies/' + studyId, function(data) {
        console.log(data);
            ...
            if (series.numberOfFrames !== undefined) {
                ...
                for (var i = 0; i < numberOfFrames; i++) {
                    ...
                    if (imageId.substr(0, 4) !== 'http') {
                        ...
                        //imageId = "dicomweb://localhost:8042/instances/" + imageId + "/file";
                        imageId = "dicomweb://localhost:3000/images/ClearCanvas/" + imageId;
                    }
                ...
                series.instanceList.forEach(function(image) {
                    ...
                    if (image.imageId.substr(0, 4) !== 'http') {
                        ...
                        //imageId = "dicomweb://localhost:8042/instances/" + image.imageId + "/file";
                        imageId = "dicomweb://localhost:3000/images/ClearCanvas/" + image.imageId;
                    }
                    //console.log(imageId);
                    stack.imageIds.push(imageId);
                });
